export const ANSWER_KEY_FIELDS = ['properlyIncluded', 'properlyExcluded', 'improperlyIncluded', 'improperlyExcluded'];
export const ANSWER_KEY_TOLERANCE = 0.01;
export const ANSWER_KEY_LABELS = {
...
export const ANSWER_KEY_PLACEHOLDER = '__choose';
export const DEFAULT_ANSWER_KEY_CLASSIFICATION = ANSWER_KEY_PLACEHOLDER;
export const DEFAULT_ANSWER_KEY_META = { assertion: '', reason: '' };

export const extractAnswerKeyMeta = (answerKey = {}) => ({
  assertion: answerKey.assertion || '',
  reason: answerKey.reason || '',
});

export const buildSingleAnswerKey = (classification, amountValue, explanation = '', meta = DEFAULT_ANSWER_KEY_META) => {
...
export const detectAnswerKeyMode = (disbursement) => {
...
export const isAnswerKeyReady = (disbursement) => {
  const amountNumber = Number(disbursement.amount || 0);
  const answerKey = disbursement.answerKey || {};
...
export const formatAnswerKeyLabel = (key, classificationFields = []) =>
